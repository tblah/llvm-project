...
! CHECK:           omp.parallel shared(%[[VAL_1]]#0 -> %[[VAL_1_SHARED:.*]] : !fir.ref<i32>) {
! CHECK:             %[[VAL_2:.*]] = arith.constant 1 : i32
! CHECK:             %[[VAL_3:.*]] = arith.constant 100 : i32
! CHECK:             %[[VAL_4:.*]] = arith.constant 1 : i32
! CHECK:             omp.wsloop private(@_QFcancel_doEi_private_i32 %[[VAL_1_SHARED]] -> %[[VAL_5:.*]] : !fir.ref<i32>) {
...
! CHECK:           omp.parallel shared(%[[VAL_2]]#0 -> %[[VAL_2_SHARED:.*]] : !fir.ref<!fir.logical<4>>) {
! CHECK:             %[[VAL_3:.*]] = fir.load %[[VAL_2_SHARED]] : !fir.ref<!fir.logical<4>>
...
! CHECK:           omp.parallel shared(%[[VAL_2]]#0 -> %[[VAL_2_SHARED:.*]], %[[VAL_4]]#0 -> %[[VAL_4_SHARED:.*]] : !fir.ref<!fir.logical<4>>, !fir.ref<i32>) {
! CHECK:             %[[VAL_5:.*]] = arith.constant 1 : i32
! CHECK:             %[[VAL_6:.*]] = arith.constant 100 : i32
! CHECK:             %[[VAL_7:.*]] = arith.constant 1 : i32
! CHECK:             omp.wsloop private(@_QFcancel_do_ifEi_private_i32 %[[VAL_4_SHARED]] -> %[[VAL_8:.*]] : !fir.ref<i32>) {
...
! CHECK:                 %[[VAL_11:.*]] = fir.load %[[VAL_2_SHARED]] : !fir.ref<!fir.logical<4>>
...
! CHECK:           omp.taskgroup {
! CHECK:             omp.task shared(%[[VAL_2]]#0 -> %[[VAL_2_SHARED:.*]] : !fir.ref<!fir.logical<4>>) {
! CHECK:               %[[VAL_3:.*]] = fir.load %[[VAL_2_SHARED]] : !fir.ref<!fir.logical<4>>
! CHECK:               %[[VAL_4:.*]] = fir.convert %[[VAL_3]] : (!fir.logical<4>) -> i1

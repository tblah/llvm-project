...
! CHECK:           omp.parallel shared(%[[VAL_5]]#0 -> %[[SHARED_Y:.*]], %[[VAL_2]]#0 -> %[[SHARED_I:.*]], %[[VAL_4]]#0 -> %[[SHARED_X:.*]] : !fir.box<!fir.array<?xi32>>, !fir.ref<i32>, !fir.ref<i32>) {
! CHECK:             %[[VAL_9:.*]] = arith.constant 1 : i32
! CHECK:             %[[VAL_10:.*]] = arith.constant 100 : i32
! CHECK:             %[[VAL_11:.*]] = arith.constant 1 : i32
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I]] -> %[[VAL_7:.*]] : !fir.ref<i32>) reduction(byref @ior_byref_i32 %[[SHARED_X]] -> %[[VAL_12:.*]] : !fir.ref<i32>) {
...
! CHECK:                 %[[VAL_17:.*]] = hlfir.designate %[[SHARED_Y]] (%[[VAL_16]])  : (!fir.box<!fir.array<?xi32>>, i64) -> !fir.ref<i32>

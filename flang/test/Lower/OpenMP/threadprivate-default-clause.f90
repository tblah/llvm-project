...
!CHECK:     omp.parallel shared(%[[A_DECL]]#0 -> %[[A_SHARED:.*]] : !fir.ref<i32>) {
!CHECK:       %[[A_TP:.*]] = omp.threadprivate %[[A_SHARED]] : !fir.ref<i32> -> !fir.ref<i32>
...
!CHECK:    omp.parallel {
!CHECK:       %[[BLK_INNER:.*]] = fir.address_of(@blk_) : !fir.ref<!fir.array<4xi8>>
!CHECK:       %[[BLK_TP:.*]] = omp.threadprivate %[[BLK_INNER]] : !fir.ref<!fir.array<4xi8>> -> !fir.ref<!fir.array<4xi8>>

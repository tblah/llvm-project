...
! CHECK:           omp.parallel shared(%[[VAL_1]]#0 -> %[[SHARED_I:.*]], %[[VAL_5]]#0 -> %[[SHARED_V:.*]] : !fir.ref<i32>, !fir.ref<!fir.box<!fir.ptr<i32>>>) {
! CHECK:             %[[VAL_20:.*]] = arith.constant 1 : i32
! CHECK:             %[[VAL_21:.*]] = arith.constant 5 : i32
! CHECK:             %[[VAL_22:.*]] = arith.constant 1 : i32
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I]] -> %[[VAL_18:.*]] : !fir.ref<i32>) reduction(byref @add_reduction_byref_box_ptr_i32 %[[SHARED_V]] -> %[[VAL_23:.*]] : !fir.ref<!fir.box<!fir.ptr<i32>>>) {

...
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I_1]] -> %[[VAL_5:.*]] : !fir.ref<i32>) reduction(@add_reduction_i32 %[[SHARED_X_1]] -> %[[VAL_10:.*]] : !fir.ref<i32>) {
...
! CHECK:             %[[VAL_8:.*]] = arith.constant 100 : i32
! CHECK:             %[[VAL_9:.*]] = arith.constant 1 : i32
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I_2]] -> %[[VAL_5:.*]] : !fir.ref<i32>) reduction(@add_reduction_f32 %[[SHARED_X_2]] -> %[[VAL_10:.*]] : !fir.ref<f32>) {
! CHECK-NEXT:          omp.loop_nest (%[[VAL_11:.*]]) : i32 = (%[[VAL_7]]) to (%[[VAL_8]]) inclusive step (%[[VAL_9]]) {
...
! CHECK:             %[[VAL_8:.*]] = arith.constant 100 : i32
! CHECK:             %[[VAL_9:.*]] = arith.constant 1 : i32
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I_3]] -> %[[VAL_5:.*]] : !fir.ref<i32>) reduction(@add_reduction_i32 %[[SHARED_X_3]] -> %[[VAL_10:.*]] : !fir.ref<i32>) {
! CHECK-NEXT:          omp.loop_nest (%[[VAL_11:.*]]) : i32 = (%[[VAL_7]]) to (%[[VAL_8]]) inclusive step (%[[VAL_9]]) {
...
! CHECK:             %[[VAL_8:.*]] = arith.constant 100 : i32
! CHECK:             %[[VAL_9:.*]] = arith.constant 1 : i32
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I_4]] -> %[[VAL_5:.*]] : !fir.ref<i32>) reduction(@add_reduction_f32 %[[SHARED_X_4]] -> %[[VAL_10:.*]] : !fir.ref<f32>) {
! CHECK-NEXT:          omp.loop_nest (%[[VAL_11:.*]]) : i32 = (%[[VAL_7]]) to (%[[VAL_8]]) inclusive step (%[[VAL_9]]) {
...
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I_5]] -> %[[VAL_11:.*]] : !fir.ref<i32>) reduction(@add_reduction_i32 %[[SHARED_X_5]] -> %[[VAL_16:.*]], @add_reduction_i32 %[[SHARED_Y_5]] -> %[[VAL_17:.*]], @add_reduction_i32 %[[SHARED_Z_5]] -> %[[VAL_18:.*]] : !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>) {
...
! CHECK:             %[[VAL_14:.*]] = arith.constant 100 : i32
! CHECK:             %[[VAL_15:.*]] = arith.constant 1 : i32
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I_6]] -> %[[VAL_11:.*]] : !fir.ref<i32>) reduction(@add_reduction_f32 %[[SHARED_X_6]] -> %[[VAL_16:.*]], @add_reduction_f32 %[[SHARED_Y_6]] -> %[[VAL_17:.*]], @add_reduction_f32 %[[SHARED_Z_6]] -> %[[VAL_18:.*]] : !fir.ref<f32>, !fir.ref<f32>, !fir.ref<f32>) {
! CHECK-NEXT:          omp.loop_nest (%[[VAL_19:.*]]) : i32 = (%[[VAL_13]]) to (%[[VAL_14]]) inclusive step (%[[VAL_15]]) {
...
! CHECK:             omp.wsloop private(@{{.*}} %[[SHARED_I_7]] -> %[[VAL_14:.*]] : !fir.ref<i32>) reduction(@add_reduction_i32 %[[SHARED_X_7]] -> %[[VAL_19:.*]], @add_reduction_i64 %[[SHARED_Y_7]] -> %[[VAL_20:.*]], @add_reduction_f32 %[[SHARED_Z_7]] -> %[[VAL_21:.*]], @add_reduction_f64 %[[SHARED_W_7]] -> %[[VAL_22:.*]] : !fir.ref<i32>, !fir.ref<i64>, !fir.ref<f32>, !fir.ref<f64>) {

...
fir::SubtreeState::getTag(llvm::StringRef uniqueName) const {
...
fir::TBAATree fir::TBAATree::buildTree(mlir::StringAttr func) {
  ...
  return TBAATree{dataRoot, boxMemberTypeDesc};
}

fir::TBAATree::TBAATree(mlir::LLVM::TBAATypeDescriptorAttr dataRoot,
                        mlir::LLVM::TBAATypeDescriptorAttr boxMemberTypeDesc)
    : globalDataTree(dataRoot.getContext(), "global data", dataRoot),
      ...
      boxMemberTypeDesc(boxMemberTypeDesc), anyDataTypeDesc(dataRoot) {}

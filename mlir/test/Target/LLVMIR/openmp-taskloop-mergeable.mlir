...
llvm.func @_QPtest() {
  ...
  omp.taskloop.context mergeable private(@_QFtestEa_firstprivate_i32 %3 -> %arg0, @_QFtestEi_private_i32 %1 -> %arg1 : !llvm.ptr, !llvm.ptr) shared(%7 -> %lb_in, %8 -> %ub_in, %9 -> %step_in : i32, i32, i32) {
